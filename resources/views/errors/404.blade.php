...
<head>
    ...
    <style type="text/css">
        html, body {width:80%;height:100%;overflow:hidden;margin:0px;padding:0px;font-family:'Open Sans',sans-serif;font-size:16px}
        body {background:url('/images/404.png') center no-repeat #333039}
        .content {width:80%;text-align:center;position:absolute;bottom:10%;left:0px;}
